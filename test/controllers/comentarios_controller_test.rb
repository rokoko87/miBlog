...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { articulo_id: @comentario.articulo_id, nombre: @comentario.nombre, texto: @comentario.texto }
    end
  ...
  test "should update comentario" do
    patch :update, id: @comentario, comentario: { articulo_id: @comentario.articulo_id, nombre: @comentario.nombre, texto: @comentario.texto }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
